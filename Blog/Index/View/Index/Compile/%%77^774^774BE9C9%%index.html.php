<?php /* Smarty version 2.6.26, created on 2014-10-27 11:41:37
         compiled from index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'index.html', 67, false),array('modifier', 'nl2br', 'index.html', 67, false),array('modifier', 'mb_substr', 'index.html', 67, false),array('modifier', 'date_format', 'index.html', 73, false),)), $this); ?>
﻿#<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
images/s1.jpg">
            ...
            <p> 
            	<a href="?a=blog&cid=<?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['cid']; ?>
&bid=<?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['bid']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['data'][$this->_sections['d']['index']]['content'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('mb_substr', true, $_tmp, 0, 400, 'utf-8') : mb_substr($_tmp, 0, 400, 'utf-8')); ?>
...</a>
            </p>
          </ul>
          <ul class="details">
